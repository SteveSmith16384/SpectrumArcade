...
public class GauntletLevel extends AbstractLevel implements ILevelGenerator {
	...
	public void generateLevel(SpectrumArcade game, int _levelNum) throws FileNotFoundException, IOException, URISyntaxException {
		...
		VoxelTerrainEntity terrainUDG = new VoxelTerrainEntity(game, 0f, 0f, 0f, new Vector3Int(image.getWidth(), WALL_HEIGHT+1, image.getHeight()), 16, 1f, 1f);
	...
	public IAvatar createAndPositionAvatar() {
		WalkingPlayer wp = new WalkingPlayer(game, getAvatarStartPos(), 4f, 5f, new GenericWalkingAvatar(game.getAssetManager(), "Textures/gauntlet/todo.png"));
