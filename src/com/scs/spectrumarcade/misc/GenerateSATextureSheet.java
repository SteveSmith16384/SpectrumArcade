...
public class GenerateSATextureSheet {
	...
	public GenerateSATextureSheet() throws IOException {
		String[][] tiles = {
				{"mm_bricks.png", "redfloor_pxl.png", "conveyor_top.png", "exit.png", "androids_wall.png", "", "conveyor_side.png", "black.png", "gauntlet_wall1.png", "gauntlet_door.png", "grass.jpg", "cutgrass.jpg"}, 
