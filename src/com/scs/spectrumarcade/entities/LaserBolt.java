...
public class LaserBolt extends AbstractPhysicalEntity implements IProcessable, INotifiedOfCollision { // todo - finish this

	public static final float SPEED = 10f;

	private long removeTime = System.currentTimeMillis() + 4000;

	public LaserBolt(SpectrumArcade _game, float x, float y, float z) {
