...
public class SlidingDoor extends AbstractPhysicalEntity implements INotifiedOfCollision, IProcessable, PhysicsTickListener {
	...
	private static final float CEILING_HEIGHT = 3f;

	private boolean isOpening = false;
	private float timeUntilClose;

	public SlidingDoor(SpectrumArcade _game, float x, float yBottom, float z, float w, float h, String tex) {
		super(_game, "SlidingDoor");

		float depth = w;//0.1f; // Default thickness
